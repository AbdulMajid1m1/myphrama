...
<body>
    ...
    <div class="ProductList1">
        <div class="ProductList2">
            ...
            <div class="card">
                <!-- <p>{{$loop->index}}</p> -->
                <img src="./images/{{ $medicine->medicineImage }}" class="card-img-top w-75" alt="...">
                <div cladss="card-body d-flex flex-column align-item-center justify-content-center">
                    <h4 class="card-title">{{ $medicine->medicineName}}</h4>
                    <p class="card-text">{{ $medicine->medicineDescription}}
                    </p>
                    <form action="{{url('cart',$medicine->id)}}"
                     method="post">
                     @csrf

                        <div class="qtyPriceDiv">
                            <h5> {{ $medicine->medicinePrice}}</h5>
                            
                            <input class="numberInput form-control" type="number" name="Quantity" value="1" min="1" style="width: 30%;" placeholder="Qty.">
                        </div>
                        <!-- <a href="#" class="btn btn-outline-danger me-1 text-light" style="background-color: #D60B51;">Add to
                        Cart</a> -->
                        <button type="submit" class="btn btn-outline-danger me-1 text-light"
                            style="background-color: #D60B51; width:100%">Add to Cart</button>
                    </form>
                </div>
            </div>
            @endforeach
